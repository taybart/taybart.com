...
const Resume = () => (<div className={style.resume}>
  <div className={style.resumelist}>
    <ul className={style.list}>
      <li>2015 bs electrical and computer engineering, university of colorado</li>
      <li>2014-2017 <b>co-founder</b> mfactor engineering</li>
      <li>2017-2018 <b>lead engineer</b> the spiga group</li>
      <li>2018-now <b>lead engineer</b> journey</li>
    </ul>
